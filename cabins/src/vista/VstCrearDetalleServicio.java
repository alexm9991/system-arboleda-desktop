...
public class VstCrearDetalleServicio extends VstBase {
    ...
    public void llenarDatos(MdlServicios servicio) {
        ...
        ctrServicios.consultarCrearDetalles(servicio);
    ...
    public void crear() throws IOException {
        ...
        ctrServicios.crearDetalle(datos, mdlServicio);
        confirmarCrearOtro();
    }
    ...
    public void confirmarQuitarImagen() {
        if (lbl.equals("true")) {
            String botones[] = {"Quitar", "Cancelar"};
            int eleccion = JOptionPane.showOptionDialog(this, "¿Desea quitar la imagen?", "",
    ...
    private void confirmarCrear() throws IOException {
        if (txt_nombre.getText().equals("") || cmb_estado.getSelectedItem().toString().equals("Seleccione...")
            ...
            int eleccion = JOptionPane.showOptionDialog(this, "¿Desea crear el detalle de servicio?", "Titulo",
                    JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, botones, this);
            if (eleccion == JOptionPane.YES_OPTION) {
                crear();
            }
    ...
    private void confirmarCrearOtro() {
        String botones[] = {"Si", "No"};
        int eleccion = JOptionPane.showOptionDialog(this, "¿Desea crear otro detalle de servicio?", "Titulo",
                JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, botones, this);
        if (eleccion == JOptionPane.YES_OPTION) {
            limpiar();
            btn_agregar_imagen.setEnabled(true);
    ...
    public VstCrearDetalleServicio() {
        initComponents();
        inicio();
    }
    ...
    private void initComponents() {
        ...
        lbl_crear_detalle.setText("CREAR DETALLE DE SERVICIO");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(lbl_imagen, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 391, javax.swing.GroupLayout.PREFERRED_SIZE)
